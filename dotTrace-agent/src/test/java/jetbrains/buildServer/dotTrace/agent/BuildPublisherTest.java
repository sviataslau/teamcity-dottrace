    ...
    public void shouldPublishAfterBuildArtifactFile() {
        ...
        final List<MethodMetric> reportMetrics =
                Arrays.asList(
                        ...
                        new MethodMetric("Namespace.One.Method2", "1", "2"),
        ...
        final Threshold thresholdsMetrics = new Threshold(
                Arrays.asList(
                        ...
                        new NamespaceMetric("Namespace.One", "F1", "F2", 0, Arrays.asList("Namespace.One.Method1", "Namespace.One.Method2")),
                        new NamespaceMetric("Namespace.Two", "F1", "F2", 100, Collections.<String>emptyList())));
